#ifndef CUSTOM_CLIENT_HELPER_H
#define CUSTOM_CLIENT_HELPER_H
 ...
 */
class CustomClientHelper : public ApplicationHelper
{
  public:
    /**
     * Create CustomClientHelper which will make life easier for people trying
     ...
     */
    CustomClientHelper(const Address& ip, uint16_t port);
    /**
     * Create CustomClientHelper which will make life easier for people trying
     * to set up simulations with echos. Use this variant with addresses that do
     ...
     */
    CustomClientHelper(const Address& addr);
